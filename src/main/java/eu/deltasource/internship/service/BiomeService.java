...
public class BiomeService {
    ...
    public BiomeService(AnimalService animalService, GroupService groupService) {
     ...
     * */
    public String updateAnimalsRepositories(BiomeList ecoSystemBiome, Gson gson, JsonObject JSONObject) {
